 ...
 * ./prisma, ./rails, ./django, ./laravel). This dispatcher only routes — keeping
 * the stacks isolated so one stack's fix can't affect another's deploy, and any
 * single stack can be disabled by removing its one line below.
 *
